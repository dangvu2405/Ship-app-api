...
function manualBody(string $uri, string $method): ?array
{
    $exact = [
        ...
        'api/payrolls' => ['company_id' => '{{companyId}}', 'month' => 5, 'year' => 2026],
        'api/payroll-adjustments' => [
            'payroll_id' => '{{payrollId}}',
            'driver_id' => '{{driverId}}',
            'type' => 'addition',
            'amount' => 100000,
            'reason' => 'Postman manual adjustment',
            'category' => 'manual',
            'source_type' => null,
            'source_id' => null,
        ],
        ...
        'api/overtime' => [
            ...
            'end_time' => '20:00',
            'ot_hours' => 2,
            'reason' => 'Postman overtime request',
        ],
        'api/violations' => [
            'company_id' => '{{companyId}}',
            'driver_id' => '{{driverId}}',
            'trip_id' => null,
            'type' => 'other',
            'occurred_at' => '2026-05-03 09:00:00',
            'description' => 'Postman violation sample',
...
function smokeFolder(array $itemsByKey): array
{
    $wanted = [
        ...
        ['GET', 'api/payrolls', 'Payrolls list'],
...
$variables = [
    ...
    'officeId' => defaultVariableValue('officeId'),
    'departmentId' => defaultVariableValue('departmentId'),
    'positionId' => defaultVariableValue('positionId'),
    ...
    'payrollId' => defaultVariableValue('payrollId'),
