...
final class StoreVehicleDocumentRequest extends AppFormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'doc_type' => ['required', 'in:registration,inspection,liability_insurance,vehicle_insurance,badge,photo,other'],
