...
class StoreDriverRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'vehicle_image' => 'nullable|url|max:255',
            'vehicle_image_front' => 'nullable|url|max:255',
            'vehicle_image_back' => 'nullable|url|max:255',
            'vehicle_image_side' => 'nullable|url|max:255',
