...
final class StoreMaintenanceRecordRequest extends AppFormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'maintenance_schedule_id' => ['nullable', 'integer', Rule::exists('maintenance_schedules', 'id')->where(fn ($query) => $query->where('company_id', $this->input('company_id')))],
